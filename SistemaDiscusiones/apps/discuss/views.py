...
class QuestionDetailView(DetailView):
	...
	def post(self, request, *args, **kwargs):
		...
		return render(request, 'discuss/question_detail.html', {'question' : answer.question, 'answers' : answers})
...
def BuscarAjax(request):
	if request.is_ajax():
		...
		data = serializers.serialize('json', questions, fields={'title', 'description', 'modified', 'slug'})
